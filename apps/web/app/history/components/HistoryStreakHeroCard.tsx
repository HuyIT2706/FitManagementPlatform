...
const HistoryStreakHeroCard = ({
  ...
  return (
    <section className="md:col-span-8 bento-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 relative overflow-hidden border border-outline-variant/30">
      ...
      <div className="flex items-start justify-between mb-4 sm:mb-6">
        <div>
          <h2 className="text-[11px] sm:text-xs font-headline-md uppercase tracking-wider text-on-surface-variant mb-1 font-semibold">
            Chuỗi Kỷ Luật & Tuân Thủ
          </h2>
          <div className="flex items-center gap-2.5 sm:gap-3">
            <Flame
              size={32}
              className="text-orange-400 animate-pulse fill-orange-400/20 shrink-0 sm:w-[38px] sm:h-[38px]"
            />
            <h1
              className="text-xl sm:text-2xl md:text-4xl font-headline-md text-on-surface font-extrabold"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-4 sm:mt-6">
        ...
        <div className="bg-surface-bright/40 border border-white/5 p-3.5 sm:p-4 rounded-xl sm:rounded-2xl">
          ...
          <div className="flex items-end gap-2">
            <span className="text-xl sm:text-2xl font-headline-md font-bold text-green-light">
