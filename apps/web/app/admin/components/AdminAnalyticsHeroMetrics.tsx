...
const AdminAnalyticsHeroMetrics = ({
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-4" suppressHydrationWarning>
      {/* Card 1: Total Users */}
      <div className="p-3.5 sm:p-5 rounded-xl sm:rounded-2xl bg-white dark:bg-[#121a15] border border-slate-200 dark:border-white/10 space-y-2 sm:space-y-3 relative overflow-hidden shadow-xs dark:shadow-none transition-colors duration-200">
        ...
        <span className="text-[10px] sm:text-[11px] text-slate-500 dark:text-white/50 font-medium block truncate">
          Học viên & người dùng hệ thống
        </span>
      </div>
      ...
      <div className="p-3.5 sm:p-5 rounded-xl sm:rounded-2xl bg-white dark:bg-[#121a15] border border-emerald-500/30 dark:border-[#10b981]/30 space-y-2 sm:space-y-3 relative overflow-hidden shadow-xs dark:shadow-[0_0_15px_rgba(16,185,129,0.08)] transition-colors duration-200">
        ...
        <span className="text-[10px] sm:text-[11px] text-emerald-600 dark:text-emerald-400 font-medium block truncate">
          Đang hướng dẫn & kèm học viên
        </span>
      </div>

      {/* Card 3: Meal Logs (Calo & Macro) */}
      <div className="p-3.5 sm:p-5 rounded-xl sm:rounded-2xl bg-white dark:bg-[#121a15] border border-slate-200 dark:border-white/10 space-y-2 sm:space-y-3 relative overflow-hidden shadow-xs dark:shadow-none transition-colors duration-200">
        <div className="flex items-center justify-between">
          <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-white/60 truncate">
            Nhật ký dinh dưỡng
        ...
        <span className="text-[10px] sm:text-[11px] text-amber-600 dark:text-amber-400 font-medium block truncate">
          Bữa ăn đã log kiểm soát Calo
        </span>
      </div>

      {/* Card 4: Workouts Scheduled */}
      <div className="p-3.5 sm:p-5 rounded-xl sm:rounded-2xl bg-white dark:bg-[#121a15] border border-slate-200 dark:border-white/10 space-y-2 sm:space-y-3 relative overflow-hidden shadow-xs dark:shadow-none transition-colors duration-200">
        <div className="flex items-center justify-between">
          <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-white/60 truncate">
            Lịch tập luyện
          </span>
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl bg-orange-50 dark:bg-orange-500/10 flex items-center justify-center text-orange-600 dark:text-orange-400 shrink-0">
            <Flame size={15} />
          </div>
        </div>
        <strong className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white block truncate">
        ...
        <span className="text-[10px] sm:text-[11px] text-orange-600 dark:text-orange-400 font-medium block truncate">
          Buổi tập đã lên giáo án & thực hiện
        </span>
      </div>

      {/* Card 5: Exercises in DB */}
      <div className="p-3.5 sm:p-5 rounded-xl sm:rounded-2xl bg-white dark:bg-[#121a15] border border-slate-200 dark:border-white/10 space-y-2 sm:space-y-3 relative overflow-hidden shadow-xs dark:shadow-none transition-colors duration-200">
        <div className="flex items-center justify-between">
          <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-white/60 truncate">
            Thư viện bài tập
        ...
        <span className="text-[10px] sm:text-[11px] text-blue-600 dark:text-blue-400 font-medium block truncate">
          Động tác chuẩn hóa để tham khảo
        </span>
      </div>
      ...
      <div className="p-3.5 sm:p-5 rounded-xl sm:rounded-2xl bg-white dark:bg-[#121a15] border border-slate-200 dark:border-white/10 space-y-2 sm:space-y-3 relative overflow-hidden shadow-xs dark:shadow-none transition-colors duration-200">
        <div className="flex items-center justify-between">
          ...
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl bg-rose-50 dark:bg-rose-500/10 flex items-center justify-center text-rose-600 dark:text-rose-400 shrink-0">
            <Utensils size={15} />
          </div>
        </div>
        <strong className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white block truncate">
        ...
        <span className="text-[10px] sm:text-[11px] text-rose-600 dark:text-rose-400 font-medium block truncate">
          Món ăn có tính Calo, Đạm, Carb, Fat
        </span>
      </div>
    </div>
  );
