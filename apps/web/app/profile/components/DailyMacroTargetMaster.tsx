    ...
    <section className="bento-card rounded-2xl p-4 sm:p-6 md:p-8 flex flex-col gap-4 sm:gap-6 border border-outline-variant/30">
      ...
      <div className="flex flex-col gap-2 mt-1 sm:mt-2">
        <div className="flex justify-between items-end">
          <span className="text-3xl sm:text-4xl font-headline-md font-extrabold text-on-surface leading-none">
            {targetCalo}{" "}
            <span className="text-lg sm:text-xl font-body-md text-on-surface-variant font-medium">
              kcal
            </span>
          </span>
        ...
        <div className="h-2.5 sm:h-3 w-full bg-surface-dim rounded-full overflow-hidden border border-white/5">
          <div
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-4 mt-1 sm:mt-2">
        <div className="flex flex-col gap-1 p-2.5 sm:p-3 rounded-xl bg-surface-bright/40 border border-white/5">
