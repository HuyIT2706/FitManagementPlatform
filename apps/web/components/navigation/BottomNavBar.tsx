      ...
      <div className="md:hidden fixed bottom-10 left-1/2 -translate-x-1/2 w-[92%] max-w-md z-50 flex items-center justify-center gap-[20px]">
        <nav className="flex items-center justify-between rounded-full p-2 shadow-lg bg-white/10 backdrop-blur-xl border border-white/20">
          ...
          <div className="flex items-center">
            <Link href="/training" className={`flex items-center gap-2 rounded-full transition-colors ${activeTab === 'workout' ? 'bg-green-light/10 text-green-light px-4 py-2' : 'w-10 h-10 justify-center text-on-surface-variant/40 hover:bg-surface-bright/10'}`}>
            ...
            <Link href="/history" className={`flex items-center gap-2 rounded-full transition-colors ${activeTab === 'history' ? 'bg-green-light/10 text-green-light px-4 py-2' : 'w-10 h-10 justify-center text-on-surface-variant/40 hover:bg-surface-bright/10'}`}>
            ...
            <Link href="/profile" className={`flex items-center gap-2 rounded-full transition-colors ${activeTab === 'profile' ? 'bg-green-light/10 text-green-light px-4 py-2' : 'w-10 h-10 justify-center text-on-surface-variant/40 hover:bg-surface-bright/10'}`}>
